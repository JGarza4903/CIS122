...
#     Total Stock($): $995.50
#
# Do you want to do another transaction? (Y)es or (N)o: Y
# 
# Select from the options below.
#
# Main Menu - 
...
#     Total Stock($): $499.50
#
# Do you want to do another transaction? (Y)es or (N)o: n
#
...
def anotherTransaction():
    """ 
    Asks the user if they want to do another transaction and returns them 
    to main menu.
    :param: none
    :return: again: boolean, True if yes, False if No
    """
    result = None
    again = ""
    again = input("\nDo you want to do another transaction? (Y)es or (N)o: ")
